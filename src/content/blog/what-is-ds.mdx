...
snippet: "Although data science very hot topic and considered the sexiest job of the 21st century, still many of us can't define DATA SCIENCE"
image:
  {
    src: "/blogcover/whatisds.jpg",
    alt: "Do you really know what is data science by Ashish Lotake"
  }
publishDate: "2022-10-17 15:39"
...
## <a name="Why define?"></a>Why define 
...
## <a name="What various sources says?"></a>What various sources says?
...
## <a name="What I have understood after learning academically for almost 1 year"></a>What I have understood after learning academically for almost 1 year
...
<PicWithCap picture="/blog/what-is-data-science/01-ds-workflow.png" />
...
## <a name="Data collections"></a>Data collections

<PicWithCap picture="/blog/what-is-data-science/02-data-collection.png" />

<PicWithCap picture="/blog/rasa_pic.png" />
...
### <a name="To better understand this, I will try to explain the various situation you may face as a data scientist:-"></a>To better understand this, I will try to explain the various situation you may face as a data scientist:-
...
## <a name="Storing Data"></a>Storing Data

<PicWithCap picture="/blog/what-is-data-science/03-data-storing.png" />

When I was in school, the teacher used to take attendance in a tabular format like this:-

<PicWithCap picture="/blog/what-is-data-science/04-tabular-data.png" />
...
## <a name="Processing Data"></a>Processing Data? 

<PicWithCap picture="/blog/what-is-data-science/05-processing-data.png" />
...
### <a name="Standardizing and Normalizing"></a>Standardizing and Normalizing

<PicWithCap picture="/blog/what-is-data-science/14-normalize-standardize.png" />
...
### <a name="How to process big data?"></a>How to process big data?

<PicWithCap picture="/blog/what-is-data-science/06-big-data.png" />
...
### <a name="Analyzing/Describing data"></a>Analyzing/Describing data

<PicWithCap picture="/blog/what-is-data-science/07-analyze-data.png" />
...
<PicWithCap picture="/blog/what-is-data-science/08-analyze-data-2.png" />
...
### <a name="Summarizing data"></a>Summarizing data
...
## <a name="Building Model"></a>Building Model

<PicWithCap picture="/blog/what-is-data-science/09-build-model.png" />

There are two ways of building a model from data;- 1. Statistical modeling 2. Algorithm modeling (Machine
Learning & Deep Learning)

### <a name="Statistical modeling"></a>Statistical modeling
...
<PicWithCap picture="/blog/what-is-data-science/10-linear-model.png" />
...
### <a name="Algorithm modeling (Machine Learning)"></a>Algorithm modeling (Machine Learning)

<PicWithCap picture="/blog/what-is-data-science/11-linear-model-2.png" />
...
### <a name="Algorithm modeling (Deep Learning)"></a>Algorithm modeling (Deep Learning)

<PicWithCap picture="/blog/what-is-data-science/12-dl-image.png" />
...
<PicWithCap picture="/blog/what-is-data-science/13-DL.png" />
